...
class MASAC:
    ...
    def update(self, samples, agent_number, logger):
        ...
        actions_next, log_probs = self.act_prob(his, next_obs) #Unlike in TD3, the next-state actions used in the target come from the current policy instead of a target policy.
